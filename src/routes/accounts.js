  ...
  try {
    ...
    try {
      ...
      const transactionResult = await client.query(
        ...
        RETURNING *`,
        [transactionRef, amount_cents, senderAccountId, receiverAccountId, description, idempotencyKey]
      );
      const transaction = transactionResult.rows[0];
      ...
      await client.query(
        ...
        (transaction_id, account_id, entry_type, amount_cents, balance_cents)
        VALUES ($1, $2, 'DEBIT', $3, $4)`,
        [transaction.id, senderAccountId, amount_cents, senderBalanceBefore - amount_cents]
      );
      ...
      await client.query(
        ...
        (transaction_id, account_id, entry_type, amount_cents, balance_cents)
        VALUES ($1, $2, 'CREDIT', $3, $4)`,
        [transaction.id, receiverAccountId, amount_cents, receiverBalanceBefore + amount_cents]
      );
